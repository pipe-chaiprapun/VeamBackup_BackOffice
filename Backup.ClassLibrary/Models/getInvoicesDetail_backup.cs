...
{
    public class getInvoicesDetail_backup
    {
    ...
    public class m_Invoices_veeam_backup
    {
    ...
    public class Get_Cal_VR {
        public decimal total_price { get; set; }
        public decimal total_price_PerDay { get; set; }
        public decimal total_vm_price { get; set; }
        public decimal total_storage_price { get; set; }
        public decimal total_processor_price { get; set; }
        public decimal total_ram_price { get; set; }
        public decimal total_ip_address_price { get; set; }
        public decimal total_networks_price { get; set; }
        public decimal total_traffic_price { get; set; }
    }
    public class m_Invoices_veeam_replication
    {
        public string name { get; set; }
    ...
    public class m_getInvoicesDetail_backup
    {
        public string invoice_no { get; set; }
        public DateTime? issued { get; set; }
        public DateTime? due { get; set; }
    ...
    public class m_getInvoicesDetail_Replication
    {
        public string invoice_no { get; set; }
        public DateTime? issued { get; set; }
        public DateTime? due { get; set; }
        ...
        public decimal ip_address_total_price { get; set; }
        public decimal traffic_total_price { get; set; }
        public decimal discount { get; set; }
        public decimal fees { get; set; }
        public DateTime? pck_start_dt { get; set; }
        public DateTime? pck_end_dt { get; set; }
